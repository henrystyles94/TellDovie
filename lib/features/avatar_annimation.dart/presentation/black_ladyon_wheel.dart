...
class BlackLadyOnWheelChair extends StatelessWidget {
  BlackLadyOnWheelChair({super.key});
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset('assets/svg/bgweel.png')
                        : animationController.selectedItem.value == 1
                            ? SizedBox(
                                height: 400.w,
                                width: 300.w,
                                child: Image.asset(
                                    'assets/svg/blackGwheelCap.png'))
                            : animationController.selectedItem.value == 2
                                ? SizedBox(
                                    ...
                                    child: Flexible(
                                        fit: FlexFit.loose,
                                        child: Image.asset(
                                            'assets/svg/blackgirlWheelCr.png')))
                                ...
                                : animationController.selectedItem.value == 4
                                    ? SizedBox(
                                        ...
                                        child: Flexible(
                                          fit: FlexFit.loose,
                                          child: Image.asset(
                                              'assets/svg/blackgirlwheelBird.png'),
                                        ),
                                      )
                                    : SizedBox(
                                        height: 400.w,
