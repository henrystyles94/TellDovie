...
class AvatarAnimationScreen extends StatefulWidget {
  AvatarAnimationScreen({super.key});

  @override
  State<AvatarAnimationScreen> createState() => _AvatarAnimationScreenState();
}

final animationController = Get.put(AvatarAnimationController());

class _AvatarAnimationScreenState extends State<AvatarAnimationScreen> {
