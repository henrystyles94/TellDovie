...
class BlackBoyFeederScreen extends StatefulWidget {
  BlackBoyFeederScreen({super.key});

  @override
  State<BlackBoyFeederScreen> createState() => _BlackBoyFeederScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackBoyFeederScreen extends State<BlackBoyFeederScreen> {
