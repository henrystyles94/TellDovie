...
class AvatarAnimationRedHeadScreen extends StatefulWidget {
  AvatarAnimationRedHeadScreen({super.key});

  @override
  State<AvatarAnimationRedHeadScreen> createState() =>
      _AvatarAnimationRedHeadScreenState();
}

final animationController = Get.put(AvatarAnimationController());

class _AvatarAnimationRedHeadScreenState
    extends State<AvatarAnimationRedHeadScreen> {
