...
class AnimateWhiteBoyScreen extends StatefulWidget {
  AnimateWhiteBoyScreen({super.key});

  @override
  State<AnimateWhiteBoyScreen> createState() => _AnimateWhiteBoyScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _AnimateWhiteBoyScreen extends State<AnimateWhiteBoyScreen> {
                        ...
                        : animationController.selectedItem.value == 1
                            ...
                            : animationController.selectedItem.value == 2
                                ...
                                : animationController.selectedItem.value == 3
                                    ? Image.asset(
                                        'assets/svg/whiteboy/bl_head/whiteC.png',
                                        width: ScreenSize.getHeight(220),
                                      )
