...
class BlackGirlYellowHeadAnimation extends StatefulWidget {
  BlackGirlYellowHeadAnimation({super.key});

  @override
  State<BlackGirlYellowHeadAnimation> createState() =>
      _BlackGirlYellowHeadAnimation();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackGirlYellowHeadAnimation
    extends State<BlackGirlYellowHeadAnimation> {
