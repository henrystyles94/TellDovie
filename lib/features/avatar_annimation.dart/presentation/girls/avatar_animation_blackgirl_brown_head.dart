...
class BlackGirlBrownHeadAnimation extends StatefulWidget {
  BlackGirlBrownHeadAnimation({super.key});

  @override
  State<BlackGirlBrownHeadAnimation> createState() =>
      _BlackGirlBrownHeadAnimation();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackGirlBrownHeadAnimation extends State<BlackGirlBrownHeadAnimation> {
