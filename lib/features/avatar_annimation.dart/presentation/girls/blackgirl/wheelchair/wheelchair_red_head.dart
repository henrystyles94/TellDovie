...
class BlackGirlWheelChairRedHeadScreen extends StatefulWidget {
  BlackGirlWheelChairRedHeadScreen({super.key});

  @override
  State<BlackGirlWheelChairRedHeadScreen> createState() =>
      _BlackGirlWheelChairRedHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackGirlWheelChairRedHeadScreen
    extends State<BlackGirlWheelChairRedHeadScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/blackgirl_curly/orange_shirt/wheelchair/r_head/red-head.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/blackgirl_curly/orange_shirt/wheelchair/r_head/red-head-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/blackgirl_curly/orange_shirt/wheelchair/r_head/red-head-cr.png',
                                    width: ScreenSize.getHeight(220),
                                  )
                                : animationController.selectedItem.value == 3
                                    ? Image.asset(
                                        'assets/svg/blackgirl_curly/orange_shirt/wheelchair/r_head/red-head-bird.png',
                                        width: ScreenSize.getHeight(220),
                                      )
                                    : Image.asset(
                                        'assets/svg/blackgirl_curly/orange_shirt/wheelchair/r_head/red-head.png',
