...
class BlackGirlWheelChairBlackHeadScreen extends StatefulWidget {
  BlackGirlWheelChairBlackHeadScreen({super.key});

  @override
  State<BlackGirlWheelChairBlackHeadScreen> createState() =>
      _BlackGirlWheelChairBlackHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackGirlWheelChairBlackHeadScreen
    extends State<BlackGirlWheelChairBlackHeadScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/blackgirl_curly/orange_shirt/wheelchair/bl_head/bl-head-wheel.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/blackgirl_curly/orange_shirt/wheelchair/bl_head/bl-head-cap.png',
                                width: ScreenSize.getHeight(200),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/blackgirl_curly/orange_shirt/wheelchair/bl_head/bl-head-crown.png',
                                    width: ScreenSize.getHeight(200),
                                  )
                                : animationController.selectedItem.value == 3
                                    ? Image.asset(
                                        'assets/svg/blackgirl_curly/orange_shirt/wheelchair/bl_head/bl-head-bird.png',
                                        width: ScreenSize.getHeight(200),
                                      )
                                    : Image.asset(
                                        'assets/svg/blackgirl_curly/orange_shirt/wheelchair/bl_head/bl-head-wheel.png',
