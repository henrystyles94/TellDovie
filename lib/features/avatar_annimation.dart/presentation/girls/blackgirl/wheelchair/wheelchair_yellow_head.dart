...
class BlackGirlWheelChairYellowHeadScreen extends StatefulWidget {
  ...
  @override
  State<BlackGirlWheelChairYellowHeadScreen> createState() =>
      _BlackGirlWheelChairYellowHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackGirlWheelChairYellowHeadScreen
    extends State<BlackGirlWheelChairYellowHeadScreen> {
