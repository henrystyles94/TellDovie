...
class BlackGirlWheelChairBrownHeadScreen extends StatefulWidget {
  BlackGirlWheelChairBrownHeadScreen({super.key});

  @override
  State<BlackGirlWheelChairBrownHeadScreen> createState() =>
      _BlackGirlWheelChairBrownHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackGirlWheelChairBrownHeadScreen
    extends State<BlackGirlWheelChairBrownHeadScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/blackgirl_curly/orange_shirt/wheelchair/br_head/brown-head.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/blackgirl_curly/orange_shirt/wheelchair/br_head/brown-head-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/blackgirl_curly/orange_shirt/wheelchair/br_head/brown-head-cr.png',
                                    width: ScreenSize.getHeight(220),
                                  )
                                : animationController.selectedItem.value == 3
                                    ? Image.asset(
                                        'assets/svg/blackgirl_curly/orange_shirt/wheelchair/br_head/brown-head-bird.png',
                                        width: ScreenSize.getHeight(220),
                                      )
                                    : Image.asset(
                                        'assets/svg/blackgirl_curly/orange_shirt/wheelchair/br_head/brown-head.png',
