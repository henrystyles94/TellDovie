...
class BlackGirlBlackHeadFeederScreen extends StatefulWidget {
  BlackGirlBlackHeadFeederScreen({super.key});

  @override
  State<BlackGirlBlackHeadFeederScreen> createState() =>
      _BlackGirlBlackHeadFeederScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackGirlBlackHeadFeederScreen
    extends State<BlackGirlBlackHeadFeederScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/blackgirl_curly/orange_shirt/feeder/bl_head/black-head.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/blackgirl_curly/orange_shirt/feeder/bl_head/black-head-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
