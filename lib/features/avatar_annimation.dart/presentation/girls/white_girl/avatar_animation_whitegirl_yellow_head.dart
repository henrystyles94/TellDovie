...
class WhiteGirlYellowHeadAnimation extends StatefulWidget {
  ...
  @override
  State<WhiteGirlYellowHeadAnimation> createState() =>
      _WhiteGirlYellowHeadAnimation();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteGirlYellowHeadAnimation
    extends State<WhiteGirlYellowHeadAnimation> {
