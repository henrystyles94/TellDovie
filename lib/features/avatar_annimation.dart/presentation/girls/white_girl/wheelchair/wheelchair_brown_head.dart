...
class WhiteGirlWheelChairBrownHeadScreen extends StatefulWidget {
  WhiteGirlWheelChairBrownHeadScreen({super.key});

  @override
  State<WhiteGirlWheelChairBrownHeadScreen> createState() =>
      _WhiteGirlWheelChairBrownHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteGirlWheelChairBrownHeadScreen
    extends State<WhiteGirlWheelChairBrownHeadScreen> {
