...
class WhiteGirlWheelChairRedHeadScreen extends StatefulWidget {
  WhiteGirlWheelChairRedHeadScreen({super.key});

  @override
  State<WhiteGirlWheelChairRedHeadScreen> createState() =>
      _WhiteGirlWheelChairRedHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteGirlWheelChairRedHeadScreen
    extends State<WhiteGirlWheelChairRedHeadScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/whitegirl/orange_shirt/wheelchair/r_head/red-head.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/whitegirl/orange_shirt/wheelchair/r_head/red-head-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/whitegirl/orange_shirt/wheelchair/r_head/red-head-crown.png',
                                    width: ScreenSize.getHeight(220),
                                  )
                                : animationController.selectedItem.value == 3
                                    ? Image.asset(
                                        'assets/svg/whitegirl/orange_shirt/wheelchair/r_head/red-head-bird.png',
                                        width: ScreenSize.getHeight(220),
                                      )
                                    : Image.asset(
                                        'assets/svg/whitegirl/orange_shirt/wheelchair/r_head/red-head.png',
