...
class WhiteGirlYellowHeadFeederScreen extends StatefulWidget {
  WhiteGirlYellowHeadFeederScreen({super.key});

  @override
  State<WhiteGirlYellowHeadFeederScreen> createState() =>
      _WhiteGirlYellowHeadFeederScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteGirlYellowHeadFeederScreen
    extends State<WhiteGirlYellowHeadFeederScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/whitegirl/orange_shirt/feeder/y_head/yhead-feeder.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/whitegirl/orange_shirt/feeder/y_head/yhead-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/whitegirl/orange_shirt/feeder/y_head/yhead-crown.png',
                                    width: ScreenSize.getHeight(220),
                                  )
                                : animationController.selectedItem.value == 3
                                    ? Flexible(
                                        fit: FlexFit.loose,
                                        child: Image.asset(
                                          'assets/svg/whitegirl/orange_shirt/feeder/y_head/yhead-fire.png',
                                          width: ScreenSize.getHeight(220),
                                        ))
                                    : animationController.selectedItem.value ==
                                            4
                                        ? Image.asset(
                                            'assets/svg/whitegirl/orange_shirt/feeder/y_head/yhead-bird.png',
                                            width: ScreenSize.getHeight(220),
                                          )
                                        : Image.asset(
                                            'assets/svg/whitegirl/orange_shirt/feeder/y_head/yhead-feeder.png',
