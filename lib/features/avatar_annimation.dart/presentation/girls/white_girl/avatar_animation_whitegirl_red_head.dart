...
class WhiteGirlRedHeadAnimation extends StatefulWidget {
  WhiteGirlRedHeadAnimation({super.key});

  @override
  State<WhiteGirlRedHeadAnimation> createState() =>
      _WhiteGirlRedHeadAnimation();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteGirlRedHeadAnimation extends State<WhiteGirlRedHeadAnimation> {
