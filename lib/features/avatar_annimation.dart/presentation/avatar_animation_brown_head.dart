...
class AvatarAnimationBrownHeadScreen extends StatefulWidget {
  AvatarAnimationBrownHeadScreen({super.key});

  @override
  State<AvatarAnimationBrownHeadScreen> createState() =>
      _AvatarAnimationBrownHeadScreenState();
}

final animationController = Get.put(AvatarAnimationController());

class _AvatarAnimationBrownHeadScreenState
    extends State<AvatarAnimationBrownHeadScreen> {
