...
class AvatarAnimationYellowHeadScreen extends StatefulWidget {
  AvatarAnimationYellowHeadScreen({super.key});

  @override
  State<AvatarAnimationYellowHeadScreen> createState() =>
      _AvatarAnimationYellowHeadScreenState();
}

final animationController = Get.put(AvatarAnimationController());

class _AvatarAnimationYellowHeadScreenState
    extends State<AvatarAnimationYellowHeadScreen> {
