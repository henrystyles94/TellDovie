...
class WhiteGirlOnWheels extends StatelessWidget {
  WhiteGirlOnWheels({super.key});
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset('assets/svg/wgweel.png')
                        : animationController.selectedItem.value == 1
                            ? SizedBox(
                                height: 400.w,
                                width: 300.w,
                                child: Image.asset(
                                    'assets/svg/whitegirlWheelCap.png'))
                            : animationController.selectedItem.value == 2
                                ? SizedBox(
                                    ...
                                    child: Flexible(
                                        fit: FlexFit.loose,
                                        child: Image.asset(
                                            'assets/svg/whitegirlWheelCr.png')))
                                ...
                                : animationController.selectedItem.value == 4
                                    ? SizedBox(
                                        ...
                                        child: Flexible(
                                          fit: FlexFit.loose,
                                          child: Image.asset(
                                              'assets/svg/whitegirlwheelBird.png'),
                                        ),
                                      )
                                    : SizedBox(
                                        height: 400.w,
