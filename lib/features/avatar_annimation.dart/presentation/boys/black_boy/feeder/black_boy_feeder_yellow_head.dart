...
class BlackBoyYellowHeadFeederScreen extends StatefulWidget {
  BlackBoyYellowHeadFeederScreen({super.key});

  @override
  State<BlackBoyYellowHeadFeederScreen> createState() =>
      _BlackBoyYellowHeadFeederScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackBoyYellowHeadFeederScreen
    extends State<BlackBoyYellowHeadFeederScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/blackboy/orange_shirt/bottle/y_head/yellow-head-bottle.png',
                            width: ScreenSize.getHeight(320),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/blackboy/orange_shirt/bottle/y_head/yellow-head-cap.png',
                                width: ScreenSize.getHeight(320),
                              )
