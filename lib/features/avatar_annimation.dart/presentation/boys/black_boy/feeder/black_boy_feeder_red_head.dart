...
class BlackBoyRedHeadFeederScreen extends StatefulWidget {
  BlackBoyRedHeadFeederScreen({super.key});

  @override
  State<BlackBoyRedHeadFeederScreen> createState() =>
      _BlackBoyRedHeadFeederScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackBoyRedHeadFeederScreen extends State<BlackBoyRedHeadFeederScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/blackboy/orange_shirt/bottle/r_head/red-head-bottle.png',
                            width: ScreenSize.getHeight(320),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/blackboy/orange_shirt/bottle/r_head/red-head-cap.png',
                                width: ScreenSize.getHeight(320),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/blackboy/orange_shirt/bottle/r_head/red-head-crown.png',
                                    width: ScreenSize.getHeight(320),
                                  )
                                : animationController.selectedItem.value == 3
                                    ? Flexible(
                                        fit: FlexFit.loose,
                                        child: Image.asset(
                                          'assets/svg/blackboy/orange_shirt/bottle/r_head/red-head-fire.png',
                                          width: ScreenSize.getHeight(320),
                                        ))
                                    : animationController.selectedItem.value ==
                                            4
                                        ? Image.asset(
                                            'assets/svg/blackboy/orange_shirt/bottle/r_head/red-head-octo.png',
                                            width: ScreenSize.getHeight(320),
                                          )
                                        : Image.asset(
                                            'assets/svg/blackboy/orange_shirt/bottle/r_head/red-head-bottle.png',
