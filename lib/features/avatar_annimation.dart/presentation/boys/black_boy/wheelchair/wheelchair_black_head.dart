...
class BlackBoyWheelChairBlackHeadScreen extends StatefulWidget {
  ...
  @override
  State<BlackBoyWheelChairBlackHeadScreen> createState() =>
      _BlackBoyWheelChairBlackHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackBoyWheelChairBlackHeadScreen
    extends State<BlackBoyWheelChairBlackHeadScreen> {
