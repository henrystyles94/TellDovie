...
class BlackBoyWheelChairBrownHeadScreen extends StatefulWidget {
  BlackBoyWheelChairBrownHeadScreen({super.key});

  @override
  State<BlackBoyWheelChairBrownHeadScreen> createState() =>
      _BlackBoyWheelChairBrownHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _BlackBoyWheelChairBrownHeadScreen
    extends State<BlackBoyWheelChairBrownHeadScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/blackboy/orange_shirt/wheelchair/br_head/brown-head.png',
                            width: ScreenSize.getHeight(300),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/blackboy/orange_shirt/wheelchair/br_head/brown-head-cap.png',
                                width: ScreenSize.getHeight(300),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/blackboy/orange_shirt/wheelchair/br_head/brown-head-cr.png',
                                    width: ScreenSize.getHeight(300),
                                  )
                                : animationController.selectedItem.value == 3
                                    ? Image.asset(
                                        'assets/svg/blackboy/orange_shirt/wheelchair/br_head/brown-head-octo.png',
                                        width: ScreenSize.getHeight(300),
                                      )
                                    : Image.asset(
                                        'assets/svg/blackboy/orange_shirt/wheelchair/br_head/brown-head.png',
