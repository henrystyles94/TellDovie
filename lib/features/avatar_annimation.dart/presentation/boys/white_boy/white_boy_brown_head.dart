...
class AnimatedWhiteBoyBrownHeadScreen extends StatefulWidget {
  AnimatedWhiteBoyBrownHeadScreen({super.key});

  @override
  State<AnimatedWhiteBoyBrownHeadScreen> createState() =>
      _AnimatedWhiteBoyBrownHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _AnimatedWhiteBoyBrownHeadScreen
    extends State<AnimatedWhiteBoyBrownHeadScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/whiteboy/br_head/brown-head.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/whiteboy/br_head/brown-head-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/whiteboy/br_head/brown-head-robot.png',
                                    width: ScreenSize.getHeight(220),
                                  )
                                : animationController.selectedItem.value == 3
                                    ...
                                    : animationController.selectedItem.value ==
                                            4
                                        ? Image.asset(
                                            'assets/svg/whiteboy/br_head/brown-head-octo.png',
                                            width: ScreenSize.getHeight(220),
                                          )
                                        : Image.asset(
                                            'assets/svg/whiteboy/br_head/brown-head.png',
