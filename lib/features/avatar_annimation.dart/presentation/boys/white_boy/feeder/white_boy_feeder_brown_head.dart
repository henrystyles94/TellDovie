...
class WhiteBoyBrownHeadFeederScreen extends StatefulWidget {
  WhiteBoyBrownHeadFeederScreen({super.key});

  @override
  State<WhiteBoyBrownHeadFeederScreen> createState() =>
      _WhiteBoyBrownHeadFeederScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteBoyBrownHeadFeederScreen
    extends State<WhiteBoyBrownHeadFeederScreen> {
