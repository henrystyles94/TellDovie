...
class WhiteBoyYellowHeadFeederScreen extends StatefulWidget {
  WhiteBoyYellowHeadFeederScreen({super.key});

  @override
  State<WhiteBoyYellowHeadFeederScreen> createState() =>
      _WhiteBoyYellowHeadFeederScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteBoyYellowHeadFeederScreen
    extends State<WhiteBoyYellowHeadFeederScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/whiteboy/orange_shirt/bottle/y_head/yhead-bottle.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/whiteboy/orange_shirt/bottle/y_head/yhead-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/whiteboy/orange_shirt/bottle/y_head/yhead-crown.png',
                                    width: ScreenSize.getHeight(220),
                                  )
                                : animationController.selectedItem.value == 3
                                    ? Flexible(
                                        fit: FlexFit.loose,
                                        child: Image.asset(
                                          'assets/svg/whiteboy/orange_shirt/bottle/y_head/yhead-fire.png',
                                          width: ScreenSize.getHeight(220),
                                        ))
                                    : animationController.selectedItem.value ==
                                            4
                                        ? Image.asset(
                                            'assets/svg/whiteboy/orange_shirt/bottle/y_head/yhead-octo.png',
                                            width: ScreenSize.getHeight(220),
                                          )
                                        : Image.asset(
                                            'assets/svg/whiteboy/orange_shirt/bottle/y_head/yhead-bottle.png',
