...
class WhiteBoyRedHeadFeederScreen extends StatefulWidget {
  WhiteBoyRedHeadFeederScreen({super.key});

  @override
  State<WhiteBoyRedHeadFeederScreen> createState() =>
      _WhiteBoyRedHeadFeederScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteBoyRedHeadFeederScreen extends State<WhiteBoyRedHeadFeederScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/whiteboy/orange_shirt/bottle/r_head/red-head.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/whiteboy/orange_shirt/bottle/r_head/red-head-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
