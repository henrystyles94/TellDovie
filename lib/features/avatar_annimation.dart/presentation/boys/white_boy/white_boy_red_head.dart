...
class AnimatedWhiteBoyRedHeadScreen extends StatefulWidget {
  AnimatedWhiteBoyRedHeadScreen({super.key});

  @override
  State<AnimatedWhiteBoyRedHeadScreen> createState() =>
      _AnimatedWhiteBoyRedHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _AnimatedWhiteBoyRedHeadScreen
    extends State<AnimatedWhiteBoyRedHeadScreen> {
  bool selectedItem1 = false;

  var items = [
    {'imgPath': 'assets/svg/yu.jpg'},
    {'imgPath': 'assets/svg/pcap.png'},
    {'imgPath': 'assets/svg/roboarm.png'},
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/whiteboy/r_head/red-head.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/whiteboy/r_head/red-head-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
                            : animationController.selectedItem.value == 2
                                ? Image.asset(
                                    'assets/svg/whiteboy/r_head/red-head-robot.png',
                                    width: ScreenSize.getHeight(220),
                                  )
                                : animationController.selectedItem.value == 3
                                    ? Image.asset(
                                        'assets/svg/whiteboy/r_head/red-head-crown.png',
                                        width: ScreenSize.getHeight(220),
                                      )
                                    : animationController.selectedItem.value ==
                                            4
                                        ? Image.asset(
                                            'assets/svg/whiteboy/r_head/red-head-octo.png',
                                            width: ScreenSize.getHeight(220),
                                          )
                                        : Image.asset(
                                            'assets/svg/whiteboy/r_head/red-head.png',
