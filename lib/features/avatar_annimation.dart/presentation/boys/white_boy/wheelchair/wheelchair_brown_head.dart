...
class WhiteBoyWheelChairBrownHeadScreen extends StatefulWidget {
  WhiteBoyWheelChairBrownHeadScreen({super.key});

  @override
  State<WhiteBoyWheelChairBrownHeadScreen> createState() =>
      _WhiteBoyWheelChairBrownHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteBoyWheelChairBrownHeadScreen
    extends State<WhiteBoyWheelChairBrownHeadScreen> {
