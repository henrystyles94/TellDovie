...
class WhiteBoyWheelChairYellowHeadScreen extends StatefulWidget {
  WhiteBoyWheelChairYellowHeadScreen({super.key});

  @override
  State<WhiteBoyWheelChairYellowHeadScreen> createState() =>
      _WhiteBoyWheelChairYellowHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteBoyWheelChairYellowHeadScreen
    extends State<WhiteBoyWheelChairYellowHeadScreen> {
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset(
                            'assets/svg/whiteboy/orange_shirt/wheelchair/y_head/yhead-wheel.png',
                            width: ScreenSize.getHeight(220),
                          )
                        : animationController.selectedItem.value == 1
                            ? Image.asset(
                                'assets/svg/whiteboy/orange_shirt/wheelchair/y_head/yhead-wheel-cap.png',
                                width: ScreenSize.getHeight(220),
                              )
                            : animationController.selectedItem.value == 2
                                ...
                                : animationController.selectedItem.value == 3
                                    ? Image.asset(
                                        'assets/svg/whiteboy/orange_shirt/wheelchair/y_head/yhead-wheel-octo.png',
                                        width: ScreenSize.getHeight(220),
                                      )
                                    : Image.asset(
                                        'assets/svg/whiteboy/orange_shirt/wheelchair/y_head/yhead-wheel.png',
