...
class WhiteBoyWheelChairBlackHeadScreen extends StatefulWidget {
  WhiteBoyWheelChairBlackHeadScreen({super.key});

  @override
  State<WhiteBoyWheelChairBlackHeadScreen> createState() =>
      _WhiteBoyWheelChairBlackHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteBoyWheelChairBlackHeadScreen
    extends State<WhiteBoyWheelChairBlackHeadScreen> {
