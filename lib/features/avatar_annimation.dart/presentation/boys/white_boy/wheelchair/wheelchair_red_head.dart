...
class WhiteBoyWheelChairRedHeadScreen extends StatefulWidget {
  WhiteBoyWheelChairRedHeadScreen({super.key});

  @override
  State<WhiteBoyWheelChairRedHeadScreen> createState() =>
      _WhiteBoyWheelChairRedHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _WhiteBoyWheelChairRedHeadScreen
    extends State<WhiteBoyWheelChairRedHeadScreen> {
