...
class AnimateWhiteBoyYellowHeadScreen extends StatefulWidget {
  AnimateWhiteBoyYellowHeadScreen({super.key});

  @override
  State<AnimateWhiteBoyYellowHeadScreen> createState() =>
      _AnimateWhiteBoyYellowHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _AnimateWhiteBoyYellowHeadScreen
    extends State<AnimateWhiteBoyYellowHeadScreen> {
