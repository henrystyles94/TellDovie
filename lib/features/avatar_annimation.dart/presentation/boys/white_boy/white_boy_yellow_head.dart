...
class AnimatedWhiteBoyYellowHeadScreen extends StatefulWidget {
  ...
  @override
  State<AnimatedWhiteBoyYellowHeadScreen> createState() =>
      _AnimatedWhiteBoyYellowHeadScreen();
}

final animationController = Get.put(AvatarAnimationController());

class _AnimatedWhiteBoyYellowHeadScreen
    extends State<AnimatedWhiteBoyYellowHeadScreen> {
