...
class WhhiteGirlFeederScreen extends StatelessWidget {
  WhhiteGirlFeederScreen({super.key});
                ...
                () => Row(
                  children: [
                    animationController.selectedItem.value == 0
                        ? Image.asset('assets/svg/whiteGF.png')
                        : animationController.selectedItem.value == 1
                            ? SizedBox(
                                height: 400.w,
                                width: 300.w,
                                child: Image.asset(
                                    'assets/svg/whiteGirlFeedwCap.png'))
                                    ...
                                    : animationController.selectedItem.value ==
                                        ...
                                        ? SizedBox(
                                            ...
                                            child: Flexible(
                                              fit: FlexFit.loose,
                                              child: Image.asset(
                                                  'assets/svg/whitegirlFeedWbird.png'),
                                            ),
                                          )
                                        : SizedBox(
                                            height: 400.w,
                  ...
                  opnPress: () async{
                    ...
                    if (animationController.selectedItem.value == 0) {
                      await preferences.setString(
                          'image', 'assets/svg/whiteGF.png');
                    } else if (animationController.selectedItem.value == 1) {
                      await preferences.setString(
                          'image', 'assets/svg/whiteGirlFeedwCap.png');
