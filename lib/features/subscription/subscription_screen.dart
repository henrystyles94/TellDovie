                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                subController.loadedPlans.value.data == null
                                    ? ''
                                    : '\$ ${subController.loadedPlans.value.data![1].price}',
                                textAlign: TextAlign.center,
                                style: AppStyles().mediumText.copyWith(
                                      fontSize: ScreenSize.getHeight(24),
                                    ),
                              ...
                              Text(
                                subController.loadedPlans.value.data!.isEmpty
                                    ? ''
                                    : ' ${subController.loadedPlans.value.data![1].name} / MO',
                                textAlign: TextAlign.center,
                                style: AppStyles().mediumText.copyWith(
                                      fontSize: ScreenSize.getHeight(24),
                                    ),
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    subController
                                            .loadedPlans.value.data!.isEmpty
                                        ? ''
                                ...
                                children: [
                                  ...
                                  Text(
                                    subController
                                            .loadedPlans.value.data!.isEmpty
                                        ? ''
                                        : '\$ ${subController.loadedPlans.value.data![0].price} / MO',
                                    //   '\$ 46.99 / MO',
                                    //   textAlign: TextAlign.center,
                                    //   style: AppStyles().mediumText.copyWith(
                                    //         fontSize: 20,
